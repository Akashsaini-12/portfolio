        ...
        <div className="container mx-auto" style={{ marginTop: 90 }}>
          <div className="row mb-n6">
            <div className="col-12 col-lg-6 mb-6">
              <div className="fw-bold font-Syne leading-none d-flex flex-wrap flex-column gap-y-2 mb-10">
                ...
                <h3 className="section-title text-dark">
                  ...
                  t’s
                  <br className="hidden d-lg-block" />
                  connect
                </h3>
              </div>
              <div className="d-flex flex-wrap flex-column gap-7">
                <div className="d-flex flex-wrap address-item">
                  <span>
                    <svg
                      width={32}
                      height={32}
                  ...
                  <div className="d-flex flex-wrap flex-column flex-1">
                    <span className="paragraph leading-none">Email us</span>
                    <h5 className="text-xl fw-bold font-Syne text-dark leading-7">
                      hello@henry.com
                    </h5>
                  </div>
                </div>
            ...
            <div className="col-12 col-lg-6 mb-6">
              <form
                id="contact-form"
                action="https://www.hiveart.xyz/perez-bootstrap/light-version/mail.php"
                method="post"
                className="row"
              >
                <div className="col-12 col-md-6">
                  <label
                    className="text-sm fw-normal font-Inter leading-tight mb-3 d-block"
                    htmlFor="name"
                  >
                    Name
                  </label>
                  <input
                    id="name"
                    className="fw-normal w-full leading-7 contact-form-control "
                    type="text"
                ...
                <div className="col-12">
                  ...
                  <textarea
                    className="fw-normal w-full contact-form-control resize-none"
                    name="message"
                    id="Message"
                    cols={30}
                    rows={10}
                ...
                <div className="col-12">
                  <div className="justify-constnt-start align-items-sm-center gap-23 d-inline-flex mt-14 flex-column flex-sm-row">
                    <svg
                      width={110}
                      height={2}
                      viewBox="0 0 110 2"
                    ...
                    <div className="d-flex flex-wrap gap-23">
                      <h4 className="text-dark text-xl fw-bold font-Syne leading-7 mb-0">
                        Follow me
                      </h4>
                      <ul className="d-flex flex-wrap gap-x-4 align-items-center p-0 list-unstyled">
                        <li>
