...
const Home = () => {
  ...
  function downloadLocalPDF(pdfUrl, filename) {
...
// Example usage
const pdfUrl = 'assets/images/pdf/Resume.pdf'; // Replace with your PDF file path or URL
    ...
    <>
      ...
      <section className="bg-secondary position-relative pt-140 pb-90">
          ...
          <div className="row">
            <div className="col-12">
              <div className="hero-content-wrapper">
                <span className="font-Syne text-dark fw-bold lh-1 text-2xl d-flex flex-wrap align-items-center hello-iam">
                  <span>
                    <svg
                ...
                <h2 class="hero-title font-Syne fw-bold mb-20">Henry</h2>
                <p class="font-Syne fw-bold text-lg leading-tight iam-designer mb-30">
                ...
                <div>
                  ...
                  <div className="d-flex flex-wrap align-items-center">
                    <div className="d-flex flex-wrap align-items-center">
                      ...
                      <span className="text-worldwide text-lg">
                        Worldwide client
                      </span>
                      <span className="mx-8">
                        <svg
        ...
        <div class="d-none d-md-block">
          <img
            class="position-absolute top-0 end-0 hero-image"
            src="assets/images/hero/hero.png"
            alt="hero Image"
          />

          <a onClick={() => navigate("/Contact")} class="contact-spin">
            <svg
            ...
            <div className="col-12 col-xl-4">
              <div className="bg-dark d-flex flex-wrap flex-column justify-content-between service-contact-card">
                <div className="d-flex flex-wrap justify-content-end">
                  <a  onClick={() => navigate("/Contact")} className="animate-arrow-up">
                    <svg
                      width={80}
                      height={80}
                      viewBox="0 0 80 80"
          ...
          <div class="row">
            <div class="col-12 col-lg-6">
              <div class="position-relative">
                ...
                <div class="d-flex flex-wrap flex-column position-absolute years-of-experience">
                  <span class="years-experience-of-number text-dark fw-bold font-Syne leading-none d-inline-block position-relative">
                    1+
                  </span>
                  <span class="strock-text">
                    Years of <br />
                    experience
                  </span>
                </div>
            ...
            <div class="col-12 col-lg-6 about-grid-space-right">
              <div class="fw-bold font-Syne leading-none d-flex flex-wrap flex-column gap-y-2">
                ...
                <h4 class="based-in-german-title text-dark">Based in German</h4>
                <p class="paragraph mb-5">
                  That is where I come in. A lover of words, a wrangler of copy.
                  Here to create copy that not only reflects who you are and
                  what you stand for, but words that truly land with those that
                ...
                <ul class="award-lists d-flex flex-wrap p-0 list-unstyled">
                  <li class="award-lists-item">
                    <span class="text-dark text-32 fw-bold font-Syne position-relative">
                      08
                    </span>
                ...
                <div class="d-flex flex-wrap">
                  <a
                   onClick={()=>{downloadLocalPDF(pdfUrl, 'AkashSaini.pdf');}}
                    class="d-flex flex-wrap align-items-center btn-primary"
                  >
                    Download my resume
      ...
      <section className="featured-properties">
        <div className="container">
          <div className="row">
            <div className="col-12 col-lg-5 col-2xl-4">
            ...
            <div className="col-12 col-lg-7 col-2xl-8 featured-properties-space-left">
                ...
                >
                  <div className="tab-contents">
                    ...
                    <p className="paragraph mb-7">
                      Mark Henry,
                      <span className="text-dark">Product Designer</span>, based
                      in German. That is where I come in. A lover of words, a
